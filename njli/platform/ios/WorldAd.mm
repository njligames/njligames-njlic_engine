...
namespace njli
{
  ...
  const char *WorldAd::getClassName() const { return "WorldAd"; }

  s32 WorldAd::getType() const { return JLI_OBJECT_TYPE_WorldAd; }
  //  s32 WorldAd::getType() const { return 0; }

  WorldAd::operator std::string() const
  {
    return ""; // njli::JsonJLI::parse(string_format("%s", FORMATSTRING));
  }

  void WorldAd::show() { mShow = true; }
