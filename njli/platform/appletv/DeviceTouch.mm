...
namespace njli
{
  ...
  ///basically the same as scale to fill but redraws itself in the drawRect call
  ///(so when bounds change) /                case UIViewContentModeRedraw: /
  ///return
  ...
  ///will assume a centered image. This mode makes the image fit into the view
  ///with its aspect ratio /                case
  ///UIViewContentModeScaleAspectFit: /                { /                    //
  ///If the aspect ratio favours width over height in relation to the images
  ///aspect ratio / if(view.frame.size.width/view.frame.size.height >
  ...
  ///reference, and minusing the blank x coordiantes on the view / return
  ...
  ///relation to the images aspect ratio /                    else
  ///if(view.frame.size.width/view.frame.size.height <
  ///view.image.size.width/view.image.size.height) /                    { / //
  ///Obtaining half of the view that is taken up by the aspect ratio / CGFloat
  ///halfAspectFit =
  ///((view.frame.size.width/view.image.size.width)*view.image.size.height)/2.0;
  ////                        // Checking whether the touch coordinate is not in
  ///a 'blank' spot on the view /                        if(touch.y >=
  ///(view.frame.size.height/2.0)-halfAspectFit /                           &&
  ///touch.y <= (view.frame.size.height/2.0)+halfAspectFit) / { / // Scaling by
  ///using the width ratio as a reference, and minusing the blank y coordinates
  ///on the view /                            return
  ...
  ////                        }
  ////                    }
  ////                    // This is just the same as a scale to fill mode if
  ///the aspect ratios from the view and the image are the same / else return
  ...
  ///ratio, meaning that it could get cut off in either axis / case
  ///UIViewContentModeScaleAspectFill: /                { / // If the aspect
  ///ratio favours width over height in relation to the images aspect ratio /
  ///if(view.frame.size.width/view.frame.size.height >
  ///view.image.size.width/view.image.size.height) /                    { / //
  ///Scaling by using the width ratio, this will cut off some height / return
  ...
  ///if(view.frame.size.width/view.frame.size.height <
  ///view.image.size.width/view.image.size.height) /                    { / //
  ///Scaling by using the height ratio, this will cut off some width / return
  ...
  ////                    }
  ////                    // Again if the aspect ratios are the same, then it
  ///will just be another copy of scale to fill mode /                    else
  ///return
  ///CGPointMake(floor(touch.x/(view.frame.size.width/view.image.size.width)),floor(touch.y/(view.frame.size.width/view.image.size.height)));
  ////                        break;
  ////                }
  ////                    // This centers the image in the view both vertically
  ///and horizontally /                case UIViewContentModeCenter: / { / //
  ///Check whether our touch is on the image centered vertically and
  ///horizontally /                    if(touch.x >=
  ///(view.frame.size.width/2.0)-(view.image.size.width/2.0) / && touch.x <=
  ///(view.frame.size.width/2.0)+(view.image.size.width/2.0) / && touch.y >=
  ///(view.frame.size.height/2.0)-(view.image.size.height/2.0) / && touch.y <=
  ///(view.frame.size.height/2.0)+(view.image.size.height/2.0)) / // Just return
  ///the touch coordinates and minus the offset /                        return
  ...
  ///to the top /                case UIViewContentModeTop: /                {
  ////                    // Check whether our touch is on the image centered
  ///horizontally and put at the vertical start /                    if(touch.x
  ///>= (view.frame.size.width/2.0)-(view.image.size.width/2.0) / && touch.x <=
  ///(view.frame.size.width/2.0)+(view.image.size.width/2.0) / && touch.y <=
  ///view.image.size.height) /                        // Just return the touch
  ///coordinates and minus the offset /                        return
  ///CGPointMake(floor(touch.x-((view.frame.size.width/2.0)-(view.image.size.width/2.0))),floor(touch.y));
  ////                        break;
  ////                }
  ////                    // This centers the image horizontally and moves it
  ///down to the bottom /                case UIViewContentModeBottom: / { / //
  ///Check whether our touch is on the image centered horizontally and put at
  ///the vertical end /                    if(touch.x >=
  ///(view.frame.size.width/2.0)-(view.image.size.width/2.0) / && touch.x <=
  ///(view.frame.size.width/2.0)+(view.image.size.width/2.0) / && touch.y >=
  ///view.frame.size.height-view.image.size.height) /                        //
  ///Just return the touch coordinates and minus the offset / return
  ...
  ///centers it vertically /                case UIViewContentModeLeft: / { / //
  ///Check whether our touch is on the image at the horizontal start and
  ///centered vertically /                    if(touch.x <=
  ///view.image.size.width /                       && touch.y >=
  ///(view.frame.size.height/2.0)-(view.image.size.height/2.0) / && touch.y <=
  ///(view.frame.size.height/2.0)+(view.image.size.height/2.0)) / return
  ...
  ///centers it vertically /                case UIViewContentModeRight: / { /
  ///if(touch.x >= view.frame.size.width-view.image.size.width / && touch.y >=
  ///(view.frame.size.height/2.0)-(view.image.size.height/2.0) / && touch.y <=
  ///(view.frame.size.height/2.0)+(view.image.size.height/2.0)) / return
  ...
  ///vertical start /                case UIViewContentModeTopLeft: / { /
  ///if(touch.x <= view.image.size.width /                       && touch.x <=
  ///view.image.size.height) /                        // My favourite / return
  ///CGPointMake(floor(touch.x),floor(touch.y)); /                        break;
  ////                }
  ////                    // This moves the image to the horizontal end and
  ///vertical start /                case UIViewContentModeTopRight: / { /
  ///if(touch.x >= view.frame.size.width-view.image.size.width / && touch.y <=
  ///view.image.size.height) /                        return
  ///CGPointMake(floor(touch.x-(view.frame.size.width-view.image.size.width)),floor(touch.y));
  ////                        break;
  ////                }
  ////                    // This moves the image to the horizontal start and
  ///vertical end /                case UIViewContentModeBottomLeft: / { /
  ///if(touch.x <= view.image.size.width /                       && touch.y <=
  ///view.frame.size.height-view.image.size.height) / return
  ...
  ///end /                case UIViewContentModeBottomRight: /                {
  ////                    if(touch.x <=
  ///view.frame.size.width-view.image.size.width /                       &&
  ///touch.y <= view.frame.size.height-view.image.size.height) / return
  ///CGPointMake(floor(touch.x-(view.frame.size.width-view.image.size.width)),floor(touch.y-(view.frame.size.height-view.image.size.height)));
  ////                        break;
  ////                }
  ////                default: break;
