...
const u8 DeviceTouch::MAX_TOUCHES = 5;
  ...
  /// UIViewContentModeScaleAspectFit: /                { / // If the aspect
  ...
  ///// This moves the image to the horizontal end and vertical start / case
  /// UIViewContentModeTopRight: / { / if(touch.x >=
  /// view.frame.size.width-view.image.size.width / && touch.y <=
