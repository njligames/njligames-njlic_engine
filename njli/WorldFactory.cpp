...
namespace njli
{
    ...
    WorldFactory::ctor(const AbstractFactoryObject &object)
    {
        ...
        case JLI_OBJECT_TYPE_ClockBuilder:
            obj =
                new ClockBuilder(*dynamic_cast<const ClockBuilder *>(&object));
            break;
        case JLI_OBJECT_TYPE_CollisionResponse:
            obj = new CollisionResponse(
        ...
        case JLI_OBJECT_TYPE_ImageBuilder:
            obj =
                new ImageBuilder(*dynamic_cast<const ImageBuilder *>(&object));
            break;
        case JLI_OBJECT_TYPE_JsonJLI:
        ...
        case JLI_OBJECT_TYPE_LightBuilder:
            obj =
                new LightBuilder(*dynamic_cast<const LightBuilder *>(&object));
            break;
        case JLI_OBJECT_TYPE_LevelOfDetail:
            obj = new LevelOfDetail(
        ...
        case JLI_OBJECT_TYPE_MeshGeometry:
            obj =
                new MeshGeometry(*dynamic_cast<const MeshGeometry *>(&object));
            break;
        case JLI_OBJECT_TYPE_MeshGeometryBuilder:
            obj = new MeshGeometryBuilder(
        ...
        case JLI_OBJECT_TYPE_PhysicsField:
            obj =
                new PhysicsField(*dynamic_cast<const PhysicsField *>(&object));
            break;
        case JLI_OBJECT_TYPE_PhysicsFieldBuilder:
            obj = new PhysicsFieldBuilder(
        ...
        case JLI_OBJECT_TYPE_PhysicsWorld:
            obj =
                new PhysicsWorld(*dynamic_cast<const PhysicsWorld *>(&object));
            break;
        case JLI_OBJECT_TYPE_PhysicsWorldBuilder:
            obj = new PhysicsWorldBuilder(
        ...
        case JLI_OBJECT_TYPE_PlaneBuilder:
            obj =
                new PlaneBuilder(*dynamic_cast<const PlaneBuilder *>(&object));
            break;
        case JLI_OBJECT_TYPE_Scene:
        ...
        case JLI_OBJECT_TYPE_SceneBuilder:
            obj =
                new SceneBuilder(*dynamic_cast<const SceneBuilder *>(&object));
            break;
        ...
        case JLI_OBJECT_TYPE_SoundBuilder:
            obj =
                new SoundBuilder(*dynamic_cast<const SoundBuilder *>(&object));
            break;
        case JLI_OBJECT_TYPE_Sprite2D:
        ...
        case JLI_OBJECT_TYPE_TimerBuilder:
            obj =
                new TimerBuilder(*dynamic_cast<const TimerBuilder *>(&object));
            break;
        case JLI_OBJECT_TYPE_Thread:
