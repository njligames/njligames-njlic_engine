...
namespace njli
{
    ...
    void SteeringBehaviorMachinePrioritized::serialize(
    ...
    SteeringBehaviorMachinePrioritized *
    SteeringBehaviorMachinePrioritized::clone(
    ...
    SteeringBehaviorMachinePrioritized *
    SteeringBehaviorMachinePrioritized::copy(
        const SteeringBehaviorMachinePrioritized &object)
    {
        return dynamic_cast<SteeringBehaviorMachinePrioritized *>(
    ...
    const btVector3 &
    SteeringBehaviorMachinePrioritized::calculateSteeringForce()
    {
