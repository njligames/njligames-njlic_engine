...
namespace njli
{
   ...
   *  <#Description#>
   */
  ATTRIBUTE_ALIGNED16(class) SteeringBehaviorAlignment : public SteeringBehavior
  {
  ...
  public:
    ...
    *  @snippet SteeringBehaviorAlignment.lua
    * SteeringBehaviorAlignment_calculateSerializeBufferSize_
    */
     ...
     * SteeringBehaviorAlignment_calculateSerializeBufferSize_
     */
    static void destroyArray(SteeringBehaviorAlignment * *array,
                             const u32 size = 0);
     ...
     * SteeringBehaviorAlignment_calculateSerializeBufferSize_
     */
    static SteeringBehaviorAlignment *clone(
        const SteeringBehaviorAlignment &object);
     ...
     * SteeringBehaviorAlignment_calculateSerializeBufferSize_
     */
    static SteeringBehaviorAlignment *copy(
        const SteeringBehaviorAlignment &object);
     ...
     * SteeringBehaviorAlignment_calculateSerializeBufferSize_
     */
    static void load(SteeringBehaviorAlignment & object, lua_State * L,
                     int stack_index);
