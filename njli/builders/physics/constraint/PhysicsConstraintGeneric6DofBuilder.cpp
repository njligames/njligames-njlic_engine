...
namespace njli
{
    ...
    s32
    PhysicsConstraintGeneric6DofBuilder::calculateSerializeBufferSize() const
    {
        return 0;
    }

    void PhysicsConstraintGeneric6DofBuilder::serialize(
        ...
        while (lua_next(L, -2))
            {
                ...
                if (lua_istable(L, -2))
                    {
                        PhysicsConstraintGeneric6DofBuilder::load(object, L,
                                                                  -2);
                    }
                else
                    {
