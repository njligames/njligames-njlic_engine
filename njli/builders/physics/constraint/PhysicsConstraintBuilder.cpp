...
namespace njli
{
  ...
  PhysicsConstraintBuilder::PhysicsConstraintBuilder(
      const PhysicsConstraintBuilder &copy)
  {
  }
  ...
  void PhysicsConstraintBuilder::serialize(void *dataBuffer,
  ...
  PhysicsConstraintBuilder::createArray(const u32 size)
  {
    return (PhysicsConstraintBuilder **)World::getInstance()
        ->getWorldFactory()
        ->createArray(PhysicsConstraintBuilder::type(), size);
  }

  void PhysicsConstraintBuilder::destroyArray(PhysicsConstraintBuilder **array,
                                              const u32 size)
  {
  ...
  {
    return dynamic_cast<PhysicsConstraintBuilder *>(
        World::getInstance()->getWorldFactory()->create(
            PhysicsConstraintBuilder::type()));
  }

  PhysicsConstraintBuilder *
  PhysicsConstraintBuilder::clone(const PhysicsConstraintBuilder &object)
  {
    return dynamic_cast<PhysicsConstraintBuilder *>(
  ...
  void PhysicsConstraintBuilder::load(PhysicsConstraintBuilder &object,
