...
namespace njli
{
  ...
  PhysicsRayContactBuilder::PhysicsRayContactBuilder(
      const PhysicsRayContactBuilder &copy)
  {
  }
  ...
  void PhysicsRayContactBuilder::serialize(void *dataBuffer,
  ...
  PhysicsRayContactBuilder::createArray(const u32 size)
  {
    return (PhysicsRayContactBuilder **)World::getInstance()
        ->getWorldFactory()
        ->createArray(PhysicsRayContactBuilder::type(), size);
  }

  void PhysicsRayContactBuilder::destroyArray(PhysicsRayContactBuilder **array,
                                              const u32 size)
  {
  ...
  {
    return dynamic_cast<PhysicsRayContactBuilder *>(
        World::getInstance()->getWorldFactory()->create(
            PhysicsRayContactBuilder::type()));
  }

  PhysicsRayContactBuilder *
  PhysicsRayContactBuilder::clone(const PhysicsRayContactBuilder &object)
  {
    return dynamic_cast<PhysicsRayContactBuilder *>(
  ...
  void PhysicsRayContactBuilder::load(PhysicsRayContactBuilder &object,
