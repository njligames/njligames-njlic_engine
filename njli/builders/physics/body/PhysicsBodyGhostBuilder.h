...
namespace njli
{
  ATTRIBUTE_ALIGNED16(class) PhysicsBodyGhostBuilder : public AbstractBuilder
  {
  ...
  public:
     ...
     */
    static void destroyArray(PhysicsBodyGhostBuilder * *array,
                             const u32 size = 0);
    /**
     *  <#Description#>
     *
     ...
     *  @return <#return value description#>
     */
    static PhysicsBodyGhostBuilder *clone(
        const PhysicsBodyGhostBuilder &object);
    /**
     *  <#Description#>
     *
     *  @param object <#object description#>
     ...
     */
    static void load(PhysicsBodyGhostBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  <#Description#>
     *
