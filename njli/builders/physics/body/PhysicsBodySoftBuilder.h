...
namespace njli
{
   ...
   *  <#Description#>
   */
  ATTRIBUTE_ALIGNED16(class) PhysicsBodySoftBuilder : public AbstractBuilder
  {
  ...
  public:
     ...
     */
    static void destroyArray(PhysicsBodySoftBuilder * *array,
                             const u32 size = 0);
    /**
     *  <#Description#>
     *
     ...
     */
    static void load(PhysicsBodySoftBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  <#Description#>
     *
