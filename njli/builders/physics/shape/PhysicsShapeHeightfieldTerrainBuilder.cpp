...
namespace njli
{
    ...
    PhysicsShapeHeightfieldTerrainBuilder::
        PhysicsShapeHeightfieldTerrainBuilder(
            const PhysicsShapeHeightfieldTerrainBuilder &copy)
    {
    }
    ...
    s32
    PhysicsShapeHeightfieldTerrainBuilder::calculateSerializeBufferSize() const
    {
        return 0;
    }

    void PhysicsShapeHeightfieldTerrainBuilder::serialize(
    ...
    PhysicsShapeHeightfieldTerrainBuilder **
    PhysicsShapeHeightfieldTerrainBuilder::createArray(const u32 size)
    {
        return (PhysicsShapeHeightfieldTerrainBuilder **)World::getInstance()
            ->getWorldFactory()
            ->createArray(PhysicsShapeHeightfieldTerrainBuilder::type(), size);
    }

    void PhysicsShapeHeightfieldTerrainBuilder::destroyArray(
        PhysicsShapeHeightfieldTerrainBuilder **array, const u32 size)
    {
    ...
    {
        return dynamic_cast<PhysicsShapeHeightfieldTerrainBuilder *>(
            World::getInstance()->getWorldFactory()->create(
                PhysicsShapeHeightfieldTerrainBuilder::type()));
    }

    PhysicsShapeHeightfieldTerrainBuilder *
    PhysicsShapeHeightfieldTerrainBuilder::clone(
    ...
    void PhysicsShapeHeightfieldTerrainBuilder::destroy(
        PhysicsShapeHeightfieldTerrainBuilder *object)
    {
        if (object)
            {
    ...
    void PhysicsShapeHeightfieldTerrainBuilder::load(
        PhysicsShapeHeightfieldTerrainBuilder &object, lua_State *L, int index)
    {
        ...
        while (lua_next(L, -2))
            {
                ...
                if (lua_istable(L, -2))
                    {
                        PhysicsShapeHeightfieldTerrainBuilder::load(object, L,
                                                                    -2);
                    }
                else
                    {
