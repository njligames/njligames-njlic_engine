...
namespace njli
{
   ...
   *  <#Description#>
   */
  ATTRIBUTE_ALIGNED16(class) PhysicsShapeCapsuleBuilder : public AbstractBuilder
  {
  ...
  public:
     ...
     */
    static void destroyArray(PhysicsShapeCapsuleBuilder * *array,
                             const u32 size = 0);
    /**
     *  <#Description#>
     *
     ...
     *  @return <#return value description#>
     */
    static PhysicsShapeCapsuleBuilder *clone(
        const PhysicsShapeCapsuleBuilder &object);
    /**
     *  <#Description#>
     *
     *  @param object <#object description#>
     ...
     */
    static void load(PhysicsShapeCapsuleBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  <#Description#>
     *
