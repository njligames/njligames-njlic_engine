...
namespace njli
{
  ...
  PhysicsShapeConvexHullBuilder::PhysicsShapeConvexHullBuilder(
      const PhysicsShapeConvexHullBuilder &copy)
  {
  }
  ...
  void PhysicsShapeConvexHullBuilder::serialize(void *dataBuffer,
  ...
  PhysicsShapeConvexHullBuilder::createArray(const u32 size)
  {
    return (PhysicsShapeConvexHullBuilder **)World::getInstance()
        ->getWorldFactory()
        ->createArray(PhysicsShapeConvexHullBuilder::type(), size);
  }

  void PhysicsShapeConvexHullBuilder::destroyArray(
      PhysicsShapeConvexHullBuilder **array, const u32 size)
  {
  ...
  {
    return dynamic_cast<PhysicsShapeConvexHullBuilder *>(
        World::getInstance()->getWorldFactory()->create(
            PhysicsShapeConvexHullBuilder::type()));
  }

  PhysicsShapeConvexHullBuilder *PhysicsShapeConvexHullBuilder::clone(
  ...
  void
  PhysicsShapeConvexHullBuilder::destroy(PhysicsShapeConvexHullBuilder *object)
  {
    if (object)
      {
  ...
  void
  PhysicsShapeConvexHullBuilder::load(PhysicsShapeConvexHullBuilder &object,
