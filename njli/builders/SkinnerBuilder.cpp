...
namespace njli
{
  ...
  s32 SkinnerBuilder::calculateSerializeBufferSize() const { return 0; }

  void SkinnerBuilder::serialize(void *dataBuffer,
                                 btSerializer *serializer) const
  {
  }

  u32 SkinnerBuilder::getObjectType() const { return JLI_OBJECT_TYPE_Skinner; }

  const char *SkinnerBuilder::getClassName() const { return "SkinnerBuilder"; }

  s32 SkinnerBuilder::getType() const { return SkinnerBuilder::type(); }
  ...
  {
    return (SkinnerBuilder **)World::getInstance()
        ->getWorldFactory()
        ->createArray(SkinnerBuilder::type(), size);
  }
  ...
  {
    return dynamic_cast<SkinnerBuilder *>(
  ...
  u32 SkinnerBuilder::type() { return JLI_OBJECT_TYPE_SkinnerBuilder; }
}
