...
namespace njli
{
   ...
   *  <#Description#>
   */
  ATTRIBUTE_ALIGNED16(class) NodeStateMachineBuilder : public AbstractBuilder
  {
  ...
  public:
     ...
     */
    static void destroyArray(NodeStateMachineBuilder * *array,
                             const u32 size = 0);
    /**
     *  <#Description#>
     *
     ...
     *  @return <#return value description#>
     */
    static NodeStateMachineBuilder *clone(
        const NodeStateMachineBuilder &object);
    /**
     *  <#Description#>
     *
     *  @param object <#object description#>
     ...
     */
    static void load(NodeStateMachineBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  <#Description#>
     *
