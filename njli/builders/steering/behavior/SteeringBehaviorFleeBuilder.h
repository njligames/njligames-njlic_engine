...
namespace njli
{
  ...
  SteeringBehaviorFleeBuilder : public AbstractBuilder
  {
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorFleeBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorFleeBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorFleeBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  Get the type of ::jliObjectEnumType enum value.
     *
