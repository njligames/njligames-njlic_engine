...
namespace njli
{
  ...
  SteeringBehaviorOffsetPursuitBuilder : public AbstractBuilder
  {
  ...
  protected:
    ...
    SteeringBehaviorOffsetPursuitBuilder(
        const SteeringBehaviorOffsetPursuitBuilder &);
    BT_DECLARE_ALIGNED_ALLOCATOR();
    virtual ~SteeringBehaviorOffsetPursuitBuilder();

    SteeringBehaviorOffsetPursuitBuilder &operator=(
        const SteeringBehaviorOffsetPursuitBuilder &);
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorOffsetPursuitBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorOffsetPursuitBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorOffsetPursuitBuilder & object,
