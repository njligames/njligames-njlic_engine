...
namespace njli
{
  ...
  SteeringBehaviorPursuitBuilder : public AbstractBuilder
  {
  ...
  protected:
    ...
    SteeringBehaviorPursuitBuilder &operator=(
        const SteeringBehaviorPursuitBuilder &);
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorPursuitBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorPursuitBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorPursuitBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  Get the type of ::jliObjectEnumType enum value.
     *
