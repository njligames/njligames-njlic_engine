...
namespace njli
{
    ...
    SteeringBehaviorFleeBuilder &SteeringBehaviorFleeBuilder::operator=(
        const SteeringBehaviorFleeBuilder &rhs)
    {
        if (this != &rhs)
        {
        }
    ...
    void SteeringBehaviorFleeBuilder::destroyArray(
        SteeringBehaviorFleeBuilder **array, const u32 size)
    {
    ...
    SteeringBehaviorFleeBuilder *SteeringBehaviorFleeBuilder::clone(
        const SteeringBehaviorFleeBuilder &object)
    {
        return dynamic_cast<SteeringBehaviorFleeBuilder *>(
    ...
    void
    SteeringBehaviorFleeBuilder::destroy(SteeringBehaviorFleeBuilder *object)
    {
