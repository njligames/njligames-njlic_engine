...
namespace njli
{
  ...
  SteeringBehaviorAlignmentBuilder : public AbstractBuilder
  {
  ...
  protected:
    ...
    SteeringBehaviorAlignmentBuilder &operator=(
        const SteeringBehaviorAlignmentBuilder &);
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorAlignmentBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorAlignmentBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorAlignmentBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  Get the type of ::jliObjectEnumType enum value.
     *
