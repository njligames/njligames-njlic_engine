...
namespace njli
{
  ...
  SteeringBehaviorSeparationBuilder : public AbstractBuilder
  {
  ...
  protected:
    ...
    SteeringBehaviorSeparationBuilder(
        const SteeringBehaviorSeparationBuilder &);
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorSeparationBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorSeparationBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorSeparationBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  Get the type of ::jliObjectEnumType enum value.
     *
