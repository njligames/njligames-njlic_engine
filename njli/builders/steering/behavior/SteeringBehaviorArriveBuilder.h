...
namespace njli
{
  ...
  SteeringBehaviorArriveBuilder : public AbstractBuilder
  {
  ...
  protected:
    ...
    SteeringBehaviorArriveBuilder &operator=(
        const SteeringBehaviorArriveBuilder &);
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorArriveBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorArriveBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorArriveBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  Get the type of ::jliObjectEnumType enum value.
     *
