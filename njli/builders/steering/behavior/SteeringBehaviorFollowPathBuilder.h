...
namespace njli
{
  ...
  SteeringBehaviorFollowPathBuilder : public AbstractBuilder
  {
  ...
  protected:
    ...
    SteeringBehaviorFollowPathBuilder(
        const SteeringBehaviorFollowPathBuilder &);
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorFollowPathBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorFollowPathBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorFollowPathBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  Get the type of ::jliObjectEnumType enum value.
     *
