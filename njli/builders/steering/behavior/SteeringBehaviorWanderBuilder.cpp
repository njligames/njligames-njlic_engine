...
namespace njli
{
    ...
    SteeringBehaviorWanderBuilder &SteeringBehaviorWanderBuilder::operator=(
        const SteeringBehaviorWanderBuilder &rhs)
    {
        if (this != &rhs)
        {
        }
    ...
    void
    SteeringBehaviorWanderBuilder::serialize(void *dataBuffer,
    ...
    void SteeringBehaviorWanderBuilder::destroy(
        SteeringBehaviorWanderBuilder *object)
    {
