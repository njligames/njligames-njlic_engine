...
namespace njli
{
    ...
    SteeringBehaviorSeekBuilder &SteeringBehaviorSeekBuilder::operator=(
        const SteeringBehaviorSeekBuilder &rhs)
    {
        if (this != &rhs)
        {
        }
    ...
    void SteeringBehaviorSeekBuilder::destroyArray(
        SteeringBehaviorSeekBuilder **array, const u32 size)
    {
    ...
    SteeringBehaviorSeekBuilder *SteeringBehaviorSeekBuilder::clone(
        const SteeringBehaviorSeekBuilder &object)
    {
        return dynamic_cast<SteeringBehaviorSeekBuilder *>(
    ...
    void
    SteeringBehaviorSeekBuilder::destroy(SteeringBehaviorSeekBuilder *object)
    {
