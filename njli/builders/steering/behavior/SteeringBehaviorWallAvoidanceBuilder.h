...
namespace njli
{
  ...
  SteeringBehaviorWallAvoidanceBuilder : public AbstractBuilder
  {
  ...
  protected:
    ...
    SteeringBehaviorWallAvoidanceBuilder(
        const SteeringBehaviorWallAvoidanceBuilder &);
    BT_DECLARE_ALIGNED_ALLOCATOR();
    virtual ~SteeringBehaviorWallAvoidanceBuilder();

    SteeringBehaviorWallAvoidanceBuilder &operator=(
        const SteeringBehaviorWallAvoidanceBuilder &);
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorWallAvoidanceBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorWallAvoidanceBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorWallAvoidanceBuilder & object,
