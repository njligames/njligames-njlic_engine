...
namespace njli
{
  ...
  SteeringBehaviorEvadeBuilder : public AbstractBuilder
  {
  ...
  protected:
    ...
    SteeringBehaviorEvadeBuilder &operator=(
        const SteeringBehaviorEvadeBuilder &);
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorEvadeBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorEvadeBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorEvadeBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  Get the type of ::jliObjectEnumType enum value.
     *
