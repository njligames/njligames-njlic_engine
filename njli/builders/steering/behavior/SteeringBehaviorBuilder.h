...
namespace njli
{
   ...
   *  Builder for <#CLASS#>
   */
  ATTRIBUTE_ALIGNED16(class) SteeringBehaviorBuilder : public AbstractBuilder
  {
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorBuilder *clone(
        const SteeringBehaviorBuilder &object);
    /**
     ...
     */
    static void load(SteeringBehaviorBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  Get the type of ::jliObjectEnumType enum value.
     *
