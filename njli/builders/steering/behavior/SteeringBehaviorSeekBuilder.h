...
namespace njli
{
  ...
  SteeringBehaviorSeekBuilder : public AbstractBuilder
  {
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorSeekBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorSeekBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorSeekBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  Get the type of ::jliObjectEnumType enum value.
     *
