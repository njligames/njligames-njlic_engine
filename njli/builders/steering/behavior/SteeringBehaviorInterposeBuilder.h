...
namespace njli
{
  ...
  SteeringBehaviorInterposeBuilder : public AbstractBuilder
  {
  ...
  protected:
    ...
    SteeringBehaviorInterposeBuilder &operator=(
        const SteeringBehaviorInterposeBuilder &);
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorInterposeBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorInterposeBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorInterposeBuilder & object, lua_State * L,
                     int stack_index);
    /**
     *  Get the type of ::jliObjectEnumType enum value.
     *
