...
namespace njli
{
  ...
  SteeringBehaviorMachineWeightedBuilder : public AbstractBuilder
  {
  ...
  protected:
    ...
    SteeringBehaviorMachineWeightedBuilder(
        const SteeringBehaviorMachineWeightedBuilder &);
    BT_DECLARE_ALIGNED_ALLOCATOR();
    virtual ~SteeringBehaviorMachineWeightedBuilder();

    SteeringBehaviorMachineWeightedBuilder &operator=(
        const SteeringBehaviorMachineWeightedBuilder &);
  ...
  public:
     ...
     */
    static void destroyArray(SteeringBehaviorMachineWeightedBuilder * *array,
                             const u32 size = 0);
    /**
     ...
     *  @return Pointer to the newly created instance.
     */
    static SteeringBehaviorMachineWeightedBuilder *clone(
     ...
     */
    static void load(SteeringBehaviorMachineWeightedBuilder & object,
