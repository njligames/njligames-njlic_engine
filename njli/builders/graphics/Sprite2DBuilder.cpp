...
namespace njli
{
  ...
  s32 Sprite2DBuilder::calculateSerializeBufferSize() const { return 0; }

  void Sprite2DBuilder::serialize(void *dataBuffer,
  ...
  s32 Sprite2DBuilder::getType() const { return Sprite2DBuilder::type(); }
  ...
  {
    return (Sprite2DBuilder **)World::getInstance()
        ->getWorldFactory()
        ->createArray(Sprite2DBuilder::type(), size);
  }
  ...
  {
    return dynamic_cast<Sprite2DBuilder *>(
        World::getInstance()->getWorldFactory()->create(
            Sprite2DBuilder::type()));
  }
