...
namespace njli
{
    ...
    Material::Material(const Material &copy)
        : AbstractFactoryObject(this),
          ...
          m_LitPerPixel(copy.m_LitPerPixel), m_DoubleSided(copy.m_DoubleSided),
    ...
    {
        return (Material **)World::getInstance()
            ->getWorldFactory()
            ->createArray(Material::type(), size);
    }
    ...
    //    void Material::addTextureIDReference(MaterialProperty
    //    *materialProperty)
    //    {
    ...
    //    }
    //    void Material::addTextureIDReference(MaterialProperty
    //    *materialProperty, AbstractFrameBufferObject *fbo)
    //    {
    //        SDL_assert(! m_TextureIDReferences.all());
    //
