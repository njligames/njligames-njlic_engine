...
namespace njli
{
    ...
    static void createFBO(GLuint &frameBuffer, GLuint &texColorBuffer,
                          GLuint &rboDepthStencil, GLsizei width,
                          GLsizei height)
    {
        // gl begin createFBO
        GLint defaultFBO;
    ...
    void AbstractFrameBufferObject::loadGPU(u32 width, u32 height)
    {
        ...
        createFBO(m_frameBufferA, m_textureA, m_stencilBufferA, m_width,
                  m_height);
        createFBO(m_frameBufferB, m_textureB, m_stencilBufferB, m_width,
                  m_height);
