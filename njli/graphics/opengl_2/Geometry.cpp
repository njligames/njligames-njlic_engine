...
//    }
    ...
    void Geometry::load(ShaderProgram *shader, const std::string &filecontent, unsigned int numInstances, unsigned int numSubDivisions)
    {
        assert(shader);
    ...
    ShaderProgram *const Geometry::getShader()
    {
        return m_Shader;
    }
