...
namespace njli
{
                                    ...
                                    const char *textString)
  {
    ...
    dd::projectedText(std::string(textString), _pos, _color, m_textMat4Buffer,
                      0, 0,
                             ...
                             bool depthEnabled)
  {
    ...
    const float _points[] = {p0.x, p0.y, p0.z, p1.x, p1.y, p1.z, p2.x, p2.y,
  ...
  void WorldDebugDrawer::setupVertexBuffers()
  {
    ...
    glBindVertexArray_NJLIC(linePointVAO);
    {
      ...
      int inColorPointSize =
          m_LinePointShaderProgram->getAttributeLocation("in_ColorPointSize");
