...
namespace njli
{
    ...
    Rect::operator std::string() const
    {
        ...
        //        std::string _dimensionFile =
        //        createJsonKeyValue("dimensionFile",
        ...
        //        std::string _sourcePosition =
        //        createJsonKeyValue("sourcePosition",
    ...
    void SpriteFrameAtlas::destroyArray(SpriteFrameAtlas **array,
                                        const u32 size)
    {
    ...
    void SpriteFrameAtlas::load(SpriteFrameAtlas &object, lua_State *L,
                                int index)
    {
