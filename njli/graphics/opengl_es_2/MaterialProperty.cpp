...
namespace njli
{
    ...
    MaterialProperty::MaterialProperty()
        : AbstractFactoryObject(this),
          ...
          m_minVal(JLI_TEXTURE_MINIFICATION_VALUE_TYPE_NEAREST),
          m_magVal(JLI_TEXTURE_MAGNIFICATION_VALUE_TYPE_NEAREST),
    ...
    void MaterialProperty::destroyArray(MaterialProperty **array,
                                        const u32 size)
    {
    ...
    void MaterialProperty::setMinificationFilter(
        njliTextureMinificationValueType val)
    {
    ...
    void
    MaterialProperty::loadGPU(const Image &negativeX, const Image &negativeY,
