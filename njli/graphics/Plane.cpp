...
namespace njli
{
    ...
    void Plane::load(ShaderProgram *shader, unsigned int numInstances,
                     unsigned int numSubDivisions)
    {
        // TODO: implement
        assert(false &&
               "need to implement: Just need to get the file content from "
               "an obj file.");
    }
    ...
    //  }
    //
    //  u64 Plane::getNumberOfVertices(LevelOfDetail *geometry, Node *node)
    //  const
    //  {
    //    return 0;
    //  }
    ...
    //  }
    //
    //  u64 Plane::getNumberOfVertexColors(LevelOfDetail *geometry, Node *node)
    //  const
    //  {
    //    return 0;
    //  }
    ...
    //  {}
    //
    //  void Plane::transformVertexColors(Node *node, const btTransform
    //  &transform) {}
    //
    ...
    //
    //  void Plane::setSize(Node *node, const btVector3 &position, const f32
    //  halfSize)
    //  {
    //    // TODO: implement
    //  }
