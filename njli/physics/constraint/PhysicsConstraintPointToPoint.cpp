...
namespace njli
{
    ...
    void
    PhysicsConstraintPointToPoint::serialize(void *dataBuffer,
    ...
    void PhysicsConstraintPointToPoint::destroy(
        PhysicsConstraintPointToPoint *object)
    {
        if (object)
            {
    ...
    {
        dynamic_cast<btPoint2PointConstraint *>(getConstraint())
            ->setPivotA(pivot);
    }
    ...
    PhysicsConstraintPointToPoint::getConstraint() const
    {
        return m_btPoint2PointConstraint;
    }
} // namespace njli
