...
namespace njli
{
    ...
    void PhysicsConstraintGeneric6DofSpring::serialize(
    ...
    PhysicsConstraintGeneric6DofSpring *
    PhysicsConstraintGeneric6DofSpring::clone(
    ...
    PhysicsConstraintGeneric6DofSpring *
    PhysicsConstraintGeneric6DofSpring::copy(
        const PhysicsConstraintGeneric6DofSpring &object)
    {
        return dynamic_cast<PhysicsConstraintGeneric6DofSpring *>(
        ...
        const btTransform &frameInB, bool useLinearReferenceFrameA)
    {
        ...
        if (rigidBodyA && !rigidBodyB)
            {
                m_btGeneric6DofSpringConstraint =
                    new btGeneric6DofSpringConstraint(*rigidBodyB, frameInB,
                                                      useLinearReferenceFrameA);
            }
        else if (rigidBodyA && rigidBodyB)
            {
                m_btGeneric6DofSpringConstraint =
                    new btGeneric6DofSpringConstraint(*rigidBodyA, *rigidBodyB,
                                                      frameInA, frameInB,
                                                      useLinearReferenceFrameA);
            }
