...
namespace njli
{
                                          ...
                                          bool useReferenceFrameA)
    {
        ...
        {
            m_btHingeConstraint = new btHingeConstraint(
                *rigidBodyA, *rigidBodyB, pivotInA, pivotInB, axisInA, axisInB,
                useReferenceFrameA);
        }
                                          ...
                                          bool useReferenceFrameA)
    {
        ...
        if (rigidBodyA && !rigidBodyB)
        {
            m_btHingeConstraint = new btHingeConstraint(*rigidBodyA, rbAFrame,
                                                        useReferenceFrameA);
        }
        else if (rigidBodyA && rigidBodyB)
        {
            m_btHingeConstraint =
                new btHingeConstraint(*rigidBodyA, *rigidBodyB, rbAFrame,
                                      rbBFrame, useReferenceFrameA);
        }
    ...
    void PhysicsConstraintHinge::setMotorTarget(const btQuaternion &qAinB,
                                                f32 dt)
    {
        btHingeConstraint *constraint =
            dynamic_cast<btHingeConstraint *>(getConstraint());
                                          ...
                                          f32 _relaxationFactor)
    {
        btHingeConstraint *constraint =
            dynamic_cast<btHingeConstraint *>(getConstraint());
        constraint->setLimit(low, high, _softness, _biasFactor,
                             _relaxationFactor);
    }
