...
namespace njli
{
    ...
    PhysicsConstraintSlider::createArray(const u32 size)
    {
                                           ...
                                           bool useLinearReferenceFrameA)
    {
        ...
        if (rigidBodyA && !rigidBodyB)
            {
                m_btSliderConstraint = new btSliderConstraint(
                    *rigidBodyA, frameInB, useLinearReferenceFrameA);
            }
        else if (rigidBodyA && rigidBodyB)
            {
                m_btSliderConstraint =
                    new btSliderConstraint(*rigidBodyA, *rigidBodyB, frameInA,
    ...
    void
    PhysicsConstraintSlider::setRestitutionOrthoLin(f32 restitutionOrthoLin)
    {
        btSliderConstraint *constraint =
            dynamic_cast<btSliderConstraint *>(getConstraint());
    ...
    void
    PhysicsConstraintSlider::setRestitutionOrthoAng(f32 restitutionOrthoAng)
    {
        btSliderConstraint *constraint =
            dynamic_cast<btSliderConstraint *>(getConstraint());
    ...
    void PhysicsConstraintSlider::setTargetLinMotorVelocity(
        f32 targetLinMotorVelocity)
    {
        btSliderConstraint *constraint =
            dynamic_cast<btSliderConstraint *>(getConstraint());
    ...
    void PhysicsConstraintSlider::setTargetAngMotorVelocity(
        f32 targetAngMotorVelocity)
    {
        btSliderConstraint *constraint =
            dynamic_cast<btSliderConstraint *>(getConstraint());
