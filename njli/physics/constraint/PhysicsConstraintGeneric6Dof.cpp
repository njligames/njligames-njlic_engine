...
namespace njli
{
    ...
    PhysicsConstraintGeneric6Dof &PhysicsConstraintGeneric6Dof::operator=(
        const PhysicsConstraintGeneric6Dof &rhs)
    {
        if (this != &rhs)
        {
        }
    ...
    PhysicsConstraintGeneric6Dof *PhysicsConstraintGeneric6Dof::copy(
        const PhysicsConstraintGeneric6Dof &object)
    {
        return dynamic_cast<PhysicsConstraintGeneric6Dof *>(
    ...
    void
    PhysicsConstraintGeneric6Dof::load(PhysicsConstraintGeneric6Dof &object,
    ...
    f32
    PhysicsConstraintGeneric6Dof::getRelativePivotPosition(int axis_index) const
    {
        const btGeneric6DofConstraint *constraint =
            dynamic_cast<const btGeneric6DofConstraint *>(getConstraint());
    ...
    void
    PhysicsConstraintGeneric6Dof::getLinearLowerLimit(btVector3 &linearLower)
    {
        btGeneric6DofConstraint *constraint =
            dynamic_cast<btGeneric6DofConstraint *>(getConstraint());
    ...
    void
    PhysicsConstraintGeneric6Dof::getLinearUpperLimit(btVector3 &linearUpper)
    {
        btGeneric6DofConstraint *constraint =
            dynamic_cast<btGeneric6DofConstraint *>(getConstraint());
