...
namespace njli
{
    ...
    void PhysicsShapeCylinder::getEdge(int i, btVector3 &pa,
                                       btVector3 &pb) const
    {
    }
    ...
    bool PhysicsShapeCylinder::isInside(const btVector3 &pt,
                                        f32 tolerance) const
    {
        return false;
    }
    ...
    btVector3
    PhysicsShapeCylinder::getAnisotropicRollingFrictionDirection() const
    {
        const btCylinderShape *cylinder =
            dynamic_cast<const btCylinderShape *>(getCollisionShape());
