...
namespace njli
{
    ...
    PhysicsShapeMultiSphere::operator=(const PhysicsShapeMultiSphere &rhs)
    {
        if (this != &rhs)
        {
        }
    ...
    PhysicsShapeMultiSphere **
    PhysicsShapeMultiSphere::createArray(const u32 size)
    {
                                            ...
                                            const f32 radius)
    {
        ...
        *m_btMultiSphereShape =
            btMultiSphereShape(&m_localPositionArray[0], &m_radiArray[0],
                               m_localPositionArray.size());
    }
    ...
    void
    PhysicsShapeMultiSphere::calculateLocalInertia(btScalar mass,
    ...
    void
    PhysicsShapeMultiSphere::setCollisionShape(const btCollisionShape &shape)
    {
        SDL_assert(shape.getShapeType() ==
                   m_btMultiSphereShape->getShapeType());
        const btMultiSphereShape *multisphere =
