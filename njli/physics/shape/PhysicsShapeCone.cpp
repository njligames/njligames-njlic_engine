...
namespace njli
{
    ...
    void PhysicsShapeCone::destroyArray(PhysicsShapeCone **array,
                                        const u32 size)
    {
    ...
    void PhysicsShapeCone::load(PhysicsShapeCone &object, lua_State *L,
                                int index)
    {
    ...
    {
        btConeShape *cylinder =
            dynamic_cast<btConeShape *>(getCollisionShape());
