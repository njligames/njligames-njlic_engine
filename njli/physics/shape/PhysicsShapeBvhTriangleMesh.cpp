...
namespace njli
{
    ...
    void PhysicsShapeBvhTriangleMesh::destroyArray(
        PhysicsShapeBvhTriangleMesh **array, const u32 size)
    {
    ...
    PhysicsShapeBvhTriangleMesh *PhysicsShapeBvhTriangleMesh::clone(
    ...
    void
    PhysicsShapeBvhTriangleMesh::destroy(PhysicsShapeBvhTriangleMesh *object)
    {
        if (object)
        {
    ...
    PhysicsShapeBvhTriangleMesh::getCollisionShape() const
    {
    ...
    void PhysicsShapeBvhTriangleMesh::setCollisionShape(
