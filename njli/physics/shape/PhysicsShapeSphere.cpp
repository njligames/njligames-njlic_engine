...
namespace njli
{
    ...
    PhysicsShapeSphere *
    PhysicsShapeSphere::copy(const PhysicsShapeSphere &object)
    {
        return dynamic_cast<PhysicsShapeSphere *>(
    ...
    //    btVector3 PhysicsShapeSphere::localGetSupportingVertex(const
    //    btVector3& vec)const
    //    {
    ...
    void PhysicsShapeSphere::setUnscaledRadius(f32 radius)
    {
        btSphereShape *sphere =
            dynamic_cast<btSphereShape *>(getCollisionShape());
