...
namespace njli
{
    ...
    void PhysicsBody::handleCollide(PhysicsBody *body,
    ...
    {
        return (
            !(IsOn(m_CollisionFlags, btCollisionObject::CF_STATIC_OBJECT)) &&
    ...
    s32 PhysicsBody::setPhysicsConstraint(PhysicsConstraint *constraint)
    {
        ...
        //            "**ADDING A CONSTRAINT TO A CHILD NODE OTHER THAN THE
        //            ROOT**", getParent()->getName(),
        //            getParent()->getParentNode()->getName());
        //      }

        //        SDL_LogWarn(SDL_LOG_CATEGORY_TEST, "%s", (getParent() &&
        //        getParent()->getParentNode())?"**ADDING A CONSTRAINT TO A
        //        CHILD NODE OTHER THAN THE ROOT**\n":"");
    ...
    bool PhysicsBody::hasPhysicsConstraint() const
    {
        ...
        //        SDL_LogVerbose(SDL_LOG_CATEGORY_TEST, "hasPhysicsConstraint:
        //        %d", s);
