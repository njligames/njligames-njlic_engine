...
namespace njli
{
    ...
    void PhysicsBodyGhost::destroyArray(PhysicsBodyGhost **array,
                                        const u32 size)
    {
    ...
    void PhysicsBodyGhost::load(PhysicsBodyGhost &object, lua_State *L,
                                int index)
    {
    ...
    {
        return dynamic_cast<btPairCachingGhostObject *>(
            m_btPairCachingGhostObject);
    }
} // namespace njli
