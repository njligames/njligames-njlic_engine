...
namespace njli
{
    ...
    void DefaultCustomPostTickCallback(btDynamicsWorld *world,
                                       btScalar timeStep)
    {
    ...
    static inline btScalar
    CustomCalculateCombinedRestitution(float restitution0, float restitution1)
    {
        ...
        int partId1, int index1)
    {
        ...
        cp.m_combinedRestitution = CustomCalculateCombinedRestitution(
            pCollisionObject0->getRestitution(),
        ...
        btBroadphaseProxy *proxy0, btBroadphaseProxy *proxy1) const
    {
        ...
        //    {
        //        shouldObjectCollide =
        //        (pBaseEntity1->shouldCollide(pBaseEntity0)
        //                                    ||
    ...
    PhysicsWorld::PhysicsWorld()
        : AbstractFactoryObject(this), m_SimulationSpeed(1.0f),
          m_TimeStep(0.0f),
          m_collisionConfiguration(new btDefaultCollisionConfiguration()),
          m_dispatcher(new btCollisionDispatcher(m_collisionConfiguration)),
          m_overlappingPairCache(new btDbvtBroadphase()),
          ...
          m_btGhostPairCallback(new btGhostPairCallback()),
          m_GhostObjects(
              new btAlignedObjectArray<btPairCachingGhostObject *>()),
          m_Paused(false) //,
    ...
    //    m_pdSolver(new btMinkowskiPenetrationDepthSolver())
    {
        ...
        m_dynamicsWorld->setInternalTickCallback(DefaultCustomPreTickCallback,
                                                 NULL, true);
    ...
    void PhysicsWorld::serialize(void *dataBuffer,
        ...
        njliBitCategories collisionMask) const
    {
        ...
        _btCollisionObjectArray.at(i); Node *_Node = (Node
        *)_btCollisionObject->getUserPointer();
    ...
    int PhysicsWorld::getVersion() const { return btGetVersion(); }
