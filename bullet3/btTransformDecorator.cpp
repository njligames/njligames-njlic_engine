...
btTransformDecorator::btTransformDecorator(btTransform *p)
    : m_buffer(new btScalar[16]), m_btTransform(p)
{
}
btTransformDecorator::~btTransformDecorator() { delete[] m_buffer; }
...
btTransformDecorator::operator std::string() const
{
    ...
    std::string temp(string_format(
        FORMATSTRING, m_buffer[0], m_buffer[1], m_buffer[2], m_buffer[3],
        m_buffer[4], m_buffer[5], m_buffer[6], m_buffer[7], m_buffer[8],
        m_buffer[9], m_buffer[10], m_buffer[11], m_buffer[12], m_buffer[13],
