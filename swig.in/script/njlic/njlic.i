                ...
                if (swig_types[i]->clientdata)
                    {
                        ...
                        // if (strcmp(name,ptr->name)==0)
                        {
                            ...
                            for (int j = 0;
                                 ptr->cls_static->ns_constants[j].name; ++j)
                                {
                                    ...
                                    sprintf(
                                        completion_value, "%s.%s", SWIG_name,
                                        ptr->cls_static->ns_constants[j].name);
                                    ...
                                    if (iter == sublime_completion_list.end())
                                        {
                                            sublime_completion_list.push_back(
                                                completion);
                                        }
                            ...
                            for (int j = 0; ptr->cls_static->ns_methods[j].name;
                                 ++j)
                                {
                                    sprintf(
                                        trigger_value, "static %s.%s",
                                        ptr->name,
                                        ptr->cls_static->ns_methods[j].name);
                                    sprintf(
                                        completion_value, "%s.%s.%s", SWIG_name,
                                        ptr->name,
                                        ptr->cls_static->ns_methods[j].name);
...
%{
    ...
    int build(lua_State * L)
    {
        ...
        if (lua_gettop(L) < 2 || lua_gettop(L) > 2)
            {
                SWIG_Lua_pushferrstring(
                    L, "Error in %s expected %d..%d args, got %d", "create", 2,
                    2, lua_gettop(L));
                lua_error(L);
                return SWIG_arg;
            }
        ...
        if (!lua_isnumber(L, 2))
            {
                SWIG_Lua_pushferrstring(
                    L, "Error in %s (arg %d), expected '%s' got '%s'", "create",
                    2, "u32", SWIG_Lua_typename(L, 2));
                lua_error(L);
                return SWIG_arg;
            }
        if (!lua_istable(L, 1))
        ...
        switch (arg1)
            ...
            case njli::JLI_OBJECT_TYPE_ActionBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__ActionBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_CameraBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__CameraBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_ClockBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__ClockBuilder,
                                       0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_CollisionResponse:
                {
                    njli::CollisionResponse *result =
                        njli::CollisionResponse::create();
                    lua_pop(L, 1);
                    njli::CollisionResponse::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__CollisionResponse, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_CollisionResponseBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__CollisionResponseBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_FontBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__FontBuilder,
                                       0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_ImageBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__ImageBuilder,
                                       0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_JsonJLIBuilder:
                {
                    njli::JsonJLIBuilder *result =
                        njli::JsonJLIBuilder::create();
                    lua_pop(L, 1);
                    njli::JsonJLIBuilder::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__JsonJLIBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_LightBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__LightBuilder,
                                       0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_LevelOfDetail:
                {
                    ...
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__LevelOfDetail, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_LevelOfDetailBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__LevelOfDetailBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_MaterialBuilder:
                {
                    njli::MaterialBuilder *result =
                        njli::MaterialBuilder::create();
                    lua_pop(L, 1);
                    njli::MaterialBuilder::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__MaterialBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_MaterialProperty:
                {
                    njli::MaterialProperty *result =
                        njli::MaterialProperty::create();
                    lua_pop(L, 1);
                    njli::MaterialProperty::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__MaterialProperty, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_MaterialPropertyBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__MaterialPropertyBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_NodeBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__NodeBuilder,
                                       0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_NodeState:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__NodeState,
                                       0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_NodeStateBuilder:
                {
                    njli::NodeStateBuilder *result =
                        njli::NodeStateBuilder::create();
                    lua_pop(L, 1);
                    njli::NodeStateBuilder::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__NodeStateBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_NodeStateMachine:
                {
                    njli::NodeStateMachine *result =
                        njli::NodeStateMachine::create();
                    lua_pop(L, 1);
                    njli::NodeStateMachine::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__NodeStateMachine, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_NodeStateMachineBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__NodeStateMachineBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_ParticleEmitter:
                {
                    njli::ParticleEmitter *result =
                        njli::ParticleEmitter::create();
                    lua_pop(L, 1);
                    njli::ParticleEmitter::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__ParticleEmitter, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_ParticleEmitterBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__ParticleEmitterBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsBodyGhost:
                {
                    njli::PhysicsBodyGhost *result =
                        njli::PhysicsBodyGhost::create();
                    lua_pop(L, 1);
                    njli::PhysicsBodyGhost::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsBodyGhost, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsBodyGhostBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsBodyGhostBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsBodyRigid:
                {
                    njli::PhysicsBodyRigid *result =
                        njli::PhysicsBodyRigid::create();
                    lua_pop(L, 1);
                    njli::PhysicsBodyRigid::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsBodyRigid, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsBodyRigidBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsBodyRigidBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsBodySoft:
                {
                    njli::PhysicsBodySoft *result =
                        njli::PhysicsBodySoft::create();
                    lua_pop(L, 1);
                    njli::PhysicsBodySoft::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsBodySoft, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsBodySoftBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsBodySoftBuilder, 0);
                    SWIG_arg++;
                }

            case njli::JLI_OBJECT_TYPE_PhysicsConstraint:
                {
                    njli::PhysicsConstraint *result =
                        njli::PhysicsConstraint::create();
                    lua_pop(L, 1);
                    njli::PhysicsConstraint::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsConstraint, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsConstraintBuilder,
                        0);
                    SWIG_arg++;
                }
            ...
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintHinge:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsConstraintHinge, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintHingeBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsConstraintHingeBuilder, 0);
                    SWIG_arg++;
                }
            ...
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintPointToPoint:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsConstraintPointToPoint, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintPointToPointBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::PhysicsConstraintPointToPointBuilder::load(*result, L,
                                                                     -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsConstraintPointToPointBuilder,
                        0);
                    SWIG_arg++;
                }
            ...
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintSlider:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsConstraintSlider, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintSliderBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsConstraintSliderBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintConeTwist:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsConstraintConeTwist,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintConeTwistBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::PhysicsConstraintConeTwistBuilder::load(*result, L,
                                                                  -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsConstraintConeTwistBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintFixed:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsConstraintFixed, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintFixedBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsConstraintFixedBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintGeneric6Dof:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsConstraintGeneric6Dof, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintGeneric6DofBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::PhysicsConstraintGeneric6DofBuilder::load(*result, L,
                                                                    -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsConstraintGeneric6DofBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsConstraintGeneric6DofSpring:
                {
                    ...
                    lua_pop(L, 1);
                    njli::PhysicsConstraintGeneric6DofSpring::load(*result, L,
                                                                   -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsConstraintGeneric6DofSpring, 0);
                    SWIG_arg++;
                }
                break;
            case njli::
                JLI_OBJECT_TYPE_PhysicsConstraintGeneric6DofSpringBuilder:
                {
                    njli::PhysicsConstraintGeneric6DofSpringBuilder *result =
                        njli::PhysicsConstraintGeneric6DofSpringBuilder::
                            create();
                    lua_pop(L, 1);
                    njli::PhysicsConstraintGeneric6DofSpringBuilder::load(
                        *result, L, -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsConstraintGeneric6DofSpringBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_PhysicsCloseContact:
                {
                    ...
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsCloseContact, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsCloseContactBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsCloseContactBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsContact:
                {
                    njli::PhysicsContact *result =
                        njli::PhysicsContact::create();
                    lua_pop(L, 1);
                    njli::PhysicsContact::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsContact, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsContactBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsContactBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsField:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__PhysicsField,
                                       0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsFieldBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsFieldBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsRayContact:
                {
                    njli::PhysicsRayContact *result =
                        njli::PhysicsRayContact::create();
                    lua_pop(L, 1);
                    njli::PhysicsRayContact::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsRayContact, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsRayContactBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsRayContactBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeBox:
                {
                    njli::PhysicsShapeBox *result =
                        njli::PhysicsShapeBox::create();
                    lua_pop(L, 1);
                    njli::PhysicsShapeBox::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsShapeBox, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeBoxBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsShapeBoxBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_PhysicsShapeBox2D:
                {
                    njli::PhysicsShapeBox2D *result =
                        njli::PhysicsShapeBox2D::create();
                    lua_pop(L, 1);
                    njli::PhysicsShapeBox2D::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsShapeBox2D, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeBox2DBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsShapeBox2DBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_PhysicsShapeSphere:
                {
                    ...
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsShapeSphere, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeSphereBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsShapeSphereBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeCylinder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsShapeCylinder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeCylinderBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsShapeCylinderBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeCapsule:
                {
                    ...
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsShapeCapsule, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeCapsuleBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsShapeCapsuleBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeCone:
                {
                    njli::PhysicsShapeCone *result =
                        njli::PhysicsShapeCone::create();
                    lua_pop(L, 1);
                    njli::PhysicsShapeCone::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsShapeCone, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeConeBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsShapeConeBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeMultiSphere:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsShapeMultiSphere, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeMultiSphereBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsShapeMultiSphereBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeConvexHull:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsShapeConvexHull, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeConvexHullBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsShapeConvexHullBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeConvexTriangleMesh:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsShapeConvexTriangleMesh, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeConvexTriangleMeshBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::PhysicsShapeConvexTriangleMeshBuilder::load(*result,
                                                                      L, -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsShapeConvexTriangleMeshBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeBvhTriangleMesh:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsShapeBvhTriangleMesh,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeBvhTriangleMeshBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::PhysicsShapeBvhTriangleMeshBuilder::load(*result, L,
                                                                   -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsShapeBvhTriangleMeshBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeHeightfieldTerrain:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsShapeHeightfieldTerrain, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeHeightfieldTerrainBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::PhysicsShapeHeightfieldTerrainBuilder::load(*result,
                                                                      L, -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsShapeHeightfieldTerrainBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeStaticPlane:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__PhysicsShapeStaticPlane, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsShapeStaticPlaneBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__PhysicsShapeStaticPlaneBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_PhysicsWorld:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__PhysicsWorld,
                                       0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_PhysicsWorldBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__PhysicsWorldBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_PlaneBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__PlaneBuilder,
                                       0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_SceneBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__SceneBuilder,
                                       0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SceneState:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__SceneState,
                                       0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SceneStateBuilder:
                {
                    njli::SceneStateBuilder *result =
                        njli::SceneStateBuilder::create();
                    lua_pop(L, 1);
                    njli::SceneStateBuilder::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__SceneStateBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SceneStateMachine:
                {
                    njli::SceneStateMachine *result =
                        njli::SceneStateMachine::create();
                    lua_pop(L, 1);
                    njli::SceneStateMachine::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__SceneStateMachine, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SceneStateMachineBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SceneStateMachineBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_ShaderProgram:
                {
                    ...
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__ShaderProgram, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_ShaderProgramBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__ShaderProgramBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_SkinnerBuilder:
                {
                    njli::SkinnerBuilder *result =
                        njli::SkinnerBuilder::create();
                    lua_pop(L, 1);
                    njli::SkinnerBuilder::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__SkinnerBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_SoundBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__SoundBuilder,
                                       0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_Sprite2DBuilder:
                {
                    njli::Sprite2DBuilder *result =
                        njli::Sprite2DBuilder::create();
                    lua_pop(L, 1);
                    njli::Sprite2DBuilder::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__Sprite2DBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SpriteFrameAtlas:
                {
                    njli::SpriteFrameAtlas *result =
                        njli::SpriteFrameAtlas::create();
                    lua_pop(L, 1);
                    njli::SpriteFrameAtlas::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__SpriteFrameAtlas, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SpriteFrameAtlasBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SpriteFrameAtlasBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_SteeringBehavior:
                {
                    njli::SteeringBehavior *result =
                        njli::SteeringBehavior::create();
                    lua_pop(L, 1);
                    njli::SteeringBehavior::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__SteeringBehavior, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorAlignment:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorAlignment,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorAlignmentBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::SteeringBehaviorAlignmentBuilder::load(*result, L,
                                                                 -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorAlignmentBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorArrive:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorArrive, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorArriveBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorArriveBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorCohesion:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorCohesion,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorCohesionBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorCohesionBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorEvade:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorEvade, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorEvadeBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorEvadeBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorFlee:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorFlee, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorFleeBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorFleeBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorFollowPath:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorFollowPath,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorFollowPathBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::SteeringBehaviorFollowPathBuilder::load(*result, L,
                                                                  -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorFollowPathBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorHide:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorHide, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorHideBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorHideBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorInterpose:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorInterpose,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorInterposeBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::SteeringBehaviorInterposeBuilder::load(*result, L,
                                                                 -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorInterposeBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorMachine:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorMachine, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorMachineBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorMachineBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorMachineDithered:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorMachineDithered, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorMachineDitheredBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::SteeringBehaviorMachineDitheredBuilder::load(*result,
                                                                       L, -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorMachineDitheredBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorMachinePrioritized:
                {
                    ...
                    lua_pop(L, 1);
                    njli::SteeringBehaviorMachinePrioritized::load(*result, L,
                                                                   -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorMachinePrioritized, 0);
                    SWIG_arg++;
                }
                break;
            case njli::
                JLI_OBJECT_TYPE_SteeringBehaviorMachinePrioritizedBuilder:
                {
                    njli::SteeringBehaviorMachinePrioritizedBuilder *result =
                        njli::SteeringBehaviorMachinePrioritizedBuilder::
                            create();
                    lua_pop(L, 1);
                    njli::SteeringBehaviorMachinePrioritizedBuilder::load(
                        *result, L, -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorMachinePrioritizedBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorMachineWeighted:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorMachineWeighted, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorMachineWeightedBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::SteeringBehaviorMachineWeightedBuilder::load(*result,
                                                                       L, -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorMachineWeightedBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorObstacleAvoidance:
                {
                    ...
                    lua_pop(L, 1);
                    njli::SteeringBehaviorObstacleAvoidance::load(*result, L,
                                                                  -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorObstacleAvoidance, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorObstacleAvoidanceBuilder:
                {
                    njli::SteeringBehaviorObstacleAvoidanceBuilder *result =
                        njli::SteeringBehaviorObstacleAvoidanceBuilder::
                            create();
                    lua_pop(L, 1);
                    njli::SteeringBehaviorObstacleAvoidanceBuilder::load(
                        *result, L, -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorObstacleAvoidanceBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorOffsetPursuit:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorOffsetPursuit, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorOffsetPursuitBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::SteeringBehaviorOffsetPursuitBuilder::load(*result, L,
                                                                     -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorOffsetPursuitBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorPursuit:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorPursuit, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorPursuitBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorPursuitBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorSeek:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorSeek, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorSeekBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorSeekBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorSeparation:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorSeparation,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorSeparationBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::SteeringBehaviorSeparationBuilder::load(*result, L,
                                                                  -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorSeparationBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorWallAvoidance:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorWallAvoidance, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorWallAvoidanceBuilder:
                {
                    ...
                    lua_pop(L, 1);
                    njli::SteeringBehaviorWallAvoidanceBuilder::load(*result, L,
                                                                     -1);
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorWallAvoidanceBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorWander:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__SteeringBehaviorWander, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_SteeringBehaviorWanderBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result,
                        SWIGTYPE_p_njli__SteeringBehaviorWanderBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_StopWatch:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__StopWatch,
                                       0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_StopWatchBuilder:
                {
                    njli::StopWatchBuilder *result =
                        njli::StopWatchBuilder::create();
                    lua_pop(L, 1);
                    njli::StopWatchBuilder::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__StopWatchBuilder, 0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_TimerBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__TimerBuilder,
                                       0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_ThreadBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__ThreadBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_WorldState:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__WorldState,
                                       0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_WorldStateBuilder:
                {
                    njli::WorldStateBuilder *result =
                        njli::WorldStateBuilder::create();
                    lua_pop(L, 1);
                    njli::WorldStateBuilder::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__WorldStateBuilder, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_WorldStateMachine:
                {
                    njli::WorldStateMachine *result =
                        njli::WorldStateMachine::create();
                    lua_pop(L, 1);
                    njli::WorldStateMachine::load(*result, L, -1);
                    SWIG_NewPointerObj(L, result,
                                       SWIGTYPE_p_njli__WorldStateMachine, 0);
                    SWIG_arg++;
                }
                break;
            case njli::JLI_OBJECT_TYPE_WorldStateMachineBuilder:
                {
                    ...
                    SWIG_NewPointerObj(
                        L, result, SWIGTYPE_p_njli__WorldStateMachineBuilder,
                        0);
                    SWIG_arg++;
                }
                break;
            ...
            case njli::JLI_OBJECT_TYPE_XmlBuilder:
                {
                    ...
                    SWIG_NewPointerObj(L, result, SWIGTYPE_p_njli__XmlBuilder,
                                       0);
                    SWIG_arg++;
                }
                break;
