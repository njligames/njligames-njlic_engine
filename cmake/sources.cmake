...
set(GLM_LOCAL_INCLUDE_DIRECTORIES "${${CMAKE_PROJECT_NAME}_REPO_DIRECTORY}/glm")
...
set(MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES "${${CMAKE_PROJECT_NAME}_REPO_DIRECTORY}/minizip")
...
file(GLOB_RECURSE SOURCE_FILES
        ...
        ${BULLET3_LOCAL_INCLUDE_DIRECTORIES}/*.c
        ${BULLET3_LOCAL_INCLUDE_DIRECTORIES}/*.cpp
        ${BULLET3_LOCAL_INCLUDE_DIRECTORIES}/*.cxx
        ${BULLET3_LOCAL_INCLUDE_DIRECTORIES}/*.m
        ${BULLET3_LOCAL_INCLUDE_DIRECTORIES}/*.mm

        ${GLM_LOCAL_INCLUDE_DIRECTORIES}/*.c
        ${GLM_LOCAL_INCLUDE_DIRECTORIES}/*.cpp
        ${GLM_LOCAL_INCLUDE_DIRECTORIES}/*.cxx
        ${GLM_LOCAL_INCLUDE_DIRECTORIES}/*.m
        ${GLM_LOCAL_INCLUDE_DIRECTORIES}/*.mm
        ...
        ${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/unzip.c
        ${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/zip.c
        )
...
if (NOT WINDOWS)
    ...
    list(APPEND SOURCE_FILES ${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/ioapi.c)
else ()
    list(APPEND SOURCE_FILES ${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/iowin32.c)
endif ()
...
file(GLOB_RECURSE INCLUDE_FILES
        ...
        ${GLM_LOCAL_INCLUDE_DIRECTORIES}/*.h
        ${GLM_LOCAL_INCLUDE_DIRECTORIES}/*.hpp
        ${GLM_LOCAL_INCLUDE_DIRECTORIES}/*.hxx
        ...
        ${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/crypt.h
        ${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/mztools.h
        ${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/unzip.h
        ${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/zip.h
...
if (NOT WINDOWS)
    ...
    list(APPEND INCLUDE_FILES ${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/ioapi.h)
else ()
    list(APPEND INCLUDE_FILES ${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/iowin32.h)
endif ()
...
SUBDIRLIST(SUBDIRS "${GLM_LOCAL_INCLUDE_DIRECTORIES}" GLM_LOCAL_INCLUDE_DIRECTORY_LIST)
...
file(GLOB MINIUNZ_MAIN_FILES
        "${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/miniunz.c"
        )

file(GLOB MINIZIP_MAIN_FILES
        "${MINIZIP_SRC_LOCAL_INCLUDE_DIRECTORIES}/minizip.c"
        )
...
list(APPEND ${CMAKE_PROJECT_NAME}_PROJECT_INCLUDE_DIRECTORES "${GLM_LOCAL_INCLUDE_DIRECTORIES}")
list(APPEND ${CMAKE_PROJECT_NAME}_PROJECT_INCLUDE_DIRECTORES "${GLM_LOCAL_INCLUDE_DIRECTORY_LIST}")
