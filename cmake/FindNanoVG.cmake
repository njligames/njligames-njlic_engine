...
if(EMSCRIPTEN)
  ...
  foreach(LIB ${SUB_LIBRARY_NAMES})
    set(${LIB}_LIBRARY_RELEASE "${CMAKE_BINARY_DIR}/${${LIBRARY_NAME_UPPER}_BASE_PATH}/Release/lib${LIB}.a")
    if(NOT EXISTS "${${LIB}_LIBRARY_RELEASE}")
      MESSAGE(FATAL_ERROR "Unable to find the library for ${${LIB}_LIBRARY_RELEASE}")
    endif()

    set(${LIB}_LIBRARY_DEBUG "${CMAKE_BINARY_DIR}/${${LIBRARY_NAME_UPPER}_BASE_PATH}/Debug/lib${LIB}.a")
