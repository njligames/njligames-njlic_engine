...
unset(THIRDPARTY_${LIBRARY_NAME_UPPER}_RELWITHDEBUGINFO_URL CACHE)
...
elseif(APPLE)
  if(IOS)
    ...
    set(PLATFORM_PATH_SUFFIX_RELWITHDEBUGINFO "RelWithDebInfo-iphoneos")
    set(PLATFORM_SIMULATOR_PATH_SUFFIX_RELWITHDEBUGINFO "RelWithDebInfo-iphonesimulator")
    ...
    if(IOS_DEVICE_RELWITHDEBUGINFO_URL)
      set(THIRDPARTY_${LIBRARY_NAME_UPPER}_RELWITHDEBUGINFO_URL "${IOS_DEVICE_RELWITHDEBUGINFO_URL}" CACHE STRING "The URL for Release Bullet3")
    endif()
    if(IOS_SIMULATOR_RELWITHDEBUGINFO_URL)
      set(THIRDPARTY_${LIBRARY_NAME_UPPER}_SIMULATOR_RELWITHDEBUGINFO_URL "${IOS_SIMULATOR_RELWITHDEBUGINFO_URL}" CACHE STRING "The URL for Release Bullet3 in the Simulator")
    endif()
  ...
  elseif(TVOS)
    ...
    if(MACOS_RELWITHDEBUGINFO_URL)
      set(THIRDPARTY_${LIBRARY_NAME_UPPER}_RELWITHDEBUGINFO_URL "${MACOS_RELWITHDEBUGINFO_URL}" CACHE STRING "The URL for Release Bullet3")
    endif()
  endif()
...
if(THIRDPARTY_${LIBRARY_NAME_UPPER}_RELWITHDEBUGINFO_URL)
  mark_as_advanced(${THIRDPARTY_${LIBRARY_NAME_UPPER}_RELWITHDEBUGINFO_URL})
  if(THIRDPARTY_${LIBRARY_NAME_UPPER}_RELWITHDEBUGINFO_URL)
    DOWNLOAD_LIBRARY_TAR(
      "${LIBRARY_NAME}"
      "${THIRDPARTY_${LIBRARY_NAME_UPPER}_RELWITHDEBUGINFO_URL}"
      "${${LIBRARY_NAME_UPPER}_BASE_PATH}/${PLATFORM_PATH_SUFFIX_RELWITHDEBUGINFO}"
      )
  endif()
endif()
...
if(THIRDPARTY_${LIBRARY_NAME_UPPER}_SIMULATOR_RELWITHDEBUGINFO_URL)
  mark_as_advanced(${THIRDPARTY_${LIBRARY_NAME_UPPER}_SIMULATOR_RELWITHDEBUGINFO_URL})
  if(THIRDPARTY_${LIBRARY_NAME_UPPER}_SIMULATOR_RELWITHDEBUGINFO_URL)
    DOWNLOAD_LIBRARY_TAR(
      "${LIBRARY_NAME}"
      "${THIRDPARTY_${LIBRARY_NAME_UPPER}_SIMULATOR_RELWITHDEBUGINFO_URL}"
      "${${LIBRARY_NAME_UPPER}_BASE_PATH}/${PLATFORM_SIMULATOR_PATH_SUFFIX_RELWITHDEBUGINFO}"
      )
  endif()
endif()
