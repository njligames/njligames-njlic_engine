...
OPTION(THIRDPARTY_CLI_ENABLED "Use CLI library" ON)
mark_as_advanced(${THIRDPARTY_CLI_ENABLED})
OPTION(USE_CLI_LIBRARY "cli typedef" ${THIRDPARTY_CLI_ENABLED})

OPTION(THIRDPARTY_CLI_ENABLED "Use CLI library" ON)
mark_as_advanced(${THIRDPARTY_CLI_ENABLED})
OPTION(DOWNLOAD_CLI_ENABLED "cli typedef" ${THIRDPARTY_CLI_ENABLED})
...
IF(USE_CLI_LIBRARY)
    include("${${CMAKE_PROJECT_NAME}_REPO_DIRECTORY}/cmake/DownloadCLI.cmake")
    list(APPEND ${CMAKE_PROJECT_NAME}_THIRDPARTY_INCLUDE_DIRS "${CLI_INCLUDE_DIRS}")

    find_package(CLI REQUIRED)
    list(APPEND EXTRA_LIBS ${CLI_TARGETS})

    list(APPEND ${CMAKE_PROJECT_NAME}_THIRDPARTY_INCLUDE_DIRS "${CLI_INCLUDE_DIR}")
endif()
