    ...
    for (;;)
    {
        ...
        vmdispatch(GET_OPCODE(i))
        {
            ...
            vmcase(OP_NOT)
            {
                TValue *rb = RB(i);
                int res =
                    l_isfalse(rb); /* next assignment may change this value */
                setbvalue(ra, res);
                vmbreak;
            }
            vmcase(OP_LEN)
            ...
            vmcase(OP_TAILCALL)
            {
                ...
                else
                {
                    ...
                    oci->u.l.base =
                        ofunc + (nci->u.l.base - nfunc); /* correct base */
                    oci->top = L->top =
                    ...
                    lua_assert(L->top ==
                               oci->u.l.base + getproto(ofunc)->maxstacksize);
                    goto newframe; /* restart luaV_execute over new Lua
                                      function */
                }
                vmbreak;
            ...
            vmcase(OP_FORLOOP)
            {
                ...
                { /* integer loop? */
                    ...
                    lua_Integer idx =
                        intop(+, ivalue(ra), step); /* increment index */
                ...
                { /* floating loop */
                    ...
                    lua_Number idx =
                        luai_numadd(L, fltvalue(ra), step); /* inc. index */
